...
func (b *EXChainRPC) ethCall(data, to string) (string, error) {
...
func (b *EXChainRPC) EthereumTypeGetErc20ContractInfo(contractDesc bchain.AddressDescriptor) (*bchain.Erc20Contract, error) {
...
func (b *EXChainRPC) EthereumTypeGetErc20ContractBalance(addrDesc, contractDesc bchain.AddressDescriptor) (*big.Int, error) {
